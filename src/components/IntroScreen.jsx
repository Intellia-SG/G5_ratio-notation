...
const JOURNEY = [
  ...
  { num: '02', icon: '📖', label: 'Story',    desc: 'Leo & Mia\'s stand' },
  ...
  return (
    <div className="intro-wrap">
      ...
      <div className="intro-top-badge">
        ✨ Curriculum · Ratio Notation Grade 5 & 6
      </div>

      {/* Main Title */}
      <h1 className="intro-title">
        <span className="text-orange">Ratio</span> <span className="text-white">Notation</span>
      </h1>
      <h2 className="intro-subtitle">RatioQuest · Master Writing, Comparing & Scaling Ratios</h2>

      {/* Mascot Row */}
      <div className="intro-mascot-row">
        <div className="intro-mascot-circle">🦁</div>
        <div className="intro-speech-bubble">
          Hi! I'm Leo. Ready to<br />write ratios and compare quantities? 🍋⚖️
        </div>
      </div>

      {/* Description */}
      <p className="intro-desc">
        Learn how to compare quantities using the <span className="text-yellow">colon (:) notation</span>, explore part-to-part and part-to-whole relationships, and scale ratios proportionally!
      </p>
      ...
      <div className="intro-ctas">
        <button type="button" className="btn-primary intro-cta-main" onClick={startFresh}>
          🚀 Begin Your Journey!
        </button>
        {hasSaved && (
          <button type="button" className="btn-outline" onClick={resumeSession} style={{ marginTop: '10px' }}>
            ↩ Resume Session
          </button>
        )}
      </div>
