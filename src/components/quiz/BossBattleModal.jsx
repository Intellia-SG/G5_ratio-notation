...
export default function BossBattleModal({ boss, questions = [], onWin, onClose, audioEnabled }) {
  ...
  const battleQuestions = questions.slice(0, 5);
      ...
      <div className="boss-modal-backdrop">
        <div className="boss-modal-card glass-card anim-bounce-in">
          ...
          <p className="boss-desc">
            Answer {battleQuestions.length} ratio questions correctly to defeat the boss!
          </p>
          ...
          <div className="boss-actions">
            <button type="button" className="btn-primary" onClick={startBattle}>
              ⚔️ Begin Boss Battle!
            </button>
    ...
    return (
      <div className="boss-modal-backdrop">
        <div className="boss-modal-card glass-card anim-celebrate">
          ...
          <button type="button" className="btn-green" onClick={onWin}>
    ...
    return (
      <div className="boss-modal-backdrop">
        <div className="boss-modal-card glass-card anim-shake">
          ...
          <p className="boss-desc">
            {boss.name} was too strong! Review the ratio rules and challenge again.
          </p>
