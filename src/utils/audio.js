...
export const sounds = {
  ...
  levelUp:  () => { tone(523, 0.08); setTimeout(() => tone(659, 0.08), 70); setTimeout(() => tone(784, 0.08), 140); setTimeout(() => tone(1047, 0.2), 210); },
  defeat:   () => { tone(300, 0.12, 'sawtooth'); setTimeout(() => tone(240, 0.12, 'sawtooth'), 100); setTimeout(() => tone(180, 0.25, 'sawtooth'), 200); },
};
